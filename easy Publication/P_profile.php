...
<a class="item active" href="P_profile.php"><i class="icon book"></i>Edit Profile</a>
...
$sql="select *
from publisher
where publisher_id='{$_SESSION['id']}'";
  ...
  ?>
            ...
            <div class="ui padded grid">
                    <div class="ui column">
                        ...
                        <form action="P_profileButton.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
