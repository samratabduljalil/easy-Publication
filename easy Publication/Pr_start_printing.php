    ...
    <div class="ui padded grid">
        <div class="three wide tablet only three wide computer only column" id="sidebar">
            <div class="ui vertical borderless fluid text menu">
                ...
                <a class="item active" href="Pr_start_printing.php"><i class="icon dollar sign"></i> need to delivary</a>
...
$d=0;
  ...
  $sql="SELECT * FROM `printing_book` WHERE  district='{$_SESSION["district"]}'";
  $rs=$con->query($sql);
...
$sql="SELECT * FROM book WHERE book_id='$a'";
  ...
  <tbody>
    <tr>
      ...
      <td><a href="Pr_customer details.php?id=<?php echo $r['Customer_id'] ?>"><button type="button"  class="btn btn-outline-success  btn-lg">View Details  </button></a></td>
    
    
     
      <td><a href="Pr_delivar_button.php?bid=<?php echo $r['book_id'] ?>&cid=<?php echo $r['Customer_id'] ?>&item=<?php echo $r['item'] ?>&district=<?php echo $r['district'] ?>&pid=<?php echo $book['Publisher_id'] ?>&pr=<?php echo $book['Price'] ?>"><button type="button"  class="btn btn-outline-success btn-lg">Delivered Successfully</button></a></td>
