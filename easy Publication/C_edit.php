    ...
    <div class="ui padded grid">
        <div class="three wide tablet only three wide computer only column" id="sidebar">
            <div class="ui vertical borderless fluid text menu">
                ...
                <a class="item active" href="C_edit.php"><i class="icon clipboard outline"></i>Edit Profile</a>
  ...
  ?>
            ...
            <div class="ui padded grid">
                    <div class="ui column">
                        ...
                        <form action="C_updateButton.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
