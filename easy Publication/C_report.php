    ...
    <div class="ui padded grid">
        <div class="three wide tablet only three wide computer only column" id="sidebar">
            <div class="ui vertical borderless fluid text menu">
                ...
                <a class="item active" href="C_report.php"><i class="icon dollar sign"></i> Report</a>
                        ...
                        <div class="ui one cards">
                            <div class="ui card">
                                ...
                                <div class="content">
                                    ...
                                    <form action="C_report_button.php">
                                    
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Write report</label>
  <textarea class="form-control" name="re"rows="3"></textarea>
</div>
