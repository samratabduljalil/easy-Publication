    ...
    <div class="ui padded grid">
        <div class="three wide tablet only three wide computer only column" id="sidebar">
            <div class="ui vertical borderless fluid text menu">
              ...
              <a class="item active" href="Pr_book_request.php"><i class="icon dollar sign"></i> Printing Request</a>
...
$d=0;
  ...
  $sql="SELECT * FROM `orders` WHERE  district='{$_SESSION["district"]}'";
  $rs=$con->query($sql);
...
$sql="SELECT * FROM book WHERE book_id='$a'";
  ...
  <tbody>
    <tr>
      ...
      <td><a href="image_down.php?file=<?php echo $book['b_image'] ?>"><button type="button"  class="btn btn-outline-success  btn-lg">download  </button></a></td>
    
    
     
      <td><a href="A_down.php?file=<?php echo $book['filelink'] ?>"><button type="button"  class="btn btn-outline-success btn-lg">download</button></a></td>
      <td><a href="Pr_printingbutton.php?bid=<?php echo $r['book_id'] ?>&cid=<?php echo $r['Customer_id'] ?>&item=<?php echo $r['item'] ?>&district=<?php echo $r['district'] ?>"><button type="button"  class="btn btn-outline-success btn-lg">Start Printing</button></a></td>
                     </tr>
