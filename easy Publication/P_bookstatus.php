    ...
    <div class="ui padded grid">
        <div class="three wide tablet only three wide computer only column" id="sidebar">
            <div class="ui vertical borderless fluid text menu">
                ...
                <a class="item active" href="P_bookstatus.php"><i class="icon book"></i>Book status</a>
                ...
                <div class="ui padded grid">
                    <div class="ui column">
                        ...
                        <div class="ui one cards">
                            <div class="ui card">
                                <div class="content">
                                    <div class="header">Submit For Review</div>
                                </div>
...
$d=0;
  ...
  $sql="SELECT * FROM `book_review` WHERE publisher_id='{$_SESSION["id"]}'";
  $rs=$con->query($sql);
  ...
  ?>
                                        <div class="ui card">
                                            <div class="image">
                                             <img src="bookcover/<?php echo $r["b_image"]?>">
                                            </div>
                                            <div class="content">
                                            <a class="header" ><?php echo $r["Title"]?></a>
                                                <div class="meta">
                                                    <span class="date">Price:<?php echo $r["Price"]?></span>
                                                </div>
                        ...
                        <div class="ui one cards">
                            <div class="ui card">
                                <div class="content">
                                    <div class="header">Published Book</div>
                                </div>
...
$sql="SELECT * FROM book WHERE publisher_id='{$_SESSION["id"]}'";
  $books=$con->query($sql);
  if($books->num_rows >0){
