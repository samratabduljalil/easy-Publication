...
$sql="SELECT * FROM book_review WHERE review_id='$a'";
  ...
  ?>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-4">
            <img src="bookcover/<?php echo $book['b_image']?>" alt="not" width="200px" />
                <h2>Title:  <?php echo $book["Title"]?></h2>
                <h4>Price:  <?php echo $book["Price"]?>৳</h4>
                <input type="number" value="1" />
<br><br>
                <a href="p.php?id=<?php echo $book['review_id']?>"><button type="button"  class="btn btn-outline-success btn-lg">Accepted</button></a>
                <br><br><br>
                <a href="notp.php?id=<?php echo $book['review_id']?>"><button type="button"  class="btn btn-outline-danger btn-lg">NOT Accepted</button></a>
                <br><br><br>
                

                <a href="A_down.php?file=<?php echo $book['filelink'] ?>"><button type="button"  class="btn btn-outline-danger btn-lg">Download pdf </button></a>
